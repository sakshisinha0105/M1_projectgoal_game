    ...
    do
{
    ...
    {
        printf("\n        OOPS !!!!  LOGIN IS UNSUCESSFUL try again");
        a++;
    ...
    if (a>2)
    {
        printf("\nSorry you have attempted wrong username and password many times ");
...
void main(void)
{
    ...
    printf("                    \t*                   Sakshi Tuitions                        *\n");
    printf("                    \t*                       Address                          *\n");
    printf("                    \t*                    Tel.1234567890                     *\n");
    printf("                    \t*                                                        *\n");
    printf("                    \t**********************************************************\n");
    printf("\n");
    printf("\n");
    ...
    system("color 0");
    printf("\n\n\t || WELCOME TO tution BILLING SYSTEM  || \n\n\n");
    for(i=0; i<80; i++)
    {
        printf("\xdb");
    }
...
void fee(int mm)
{
    ...
    while(c=='y'||c=='Y')
    {
        ...
        while(fread(&stud,sizeof(stud),1,f)==1)
        {
            ...
            {
                a=0;
                printf("\n\nEnter the month & day till which fee should be paid:: ");
                fflush(stdin);
                scanf("%d",&month);
...
void ext()
{
    int i;
    system("color 0b");
    printf("\n\n\t\t Thanks for using our tution's Billing System. .\n\n");
    system("pause");
    system("cls");
    printf("\n\n\t\t\t Exiting In A Moment\n\n");
    for(i=1; i<=60; i++)
